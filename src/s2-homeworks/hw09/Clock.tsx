...
function Clock() {
    ...
    const stringDate = Intl.DateTimeFormat("ru") || <br/> // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
    ...
    return (
        <div className={s.clock}>
            ...
            >
                ...
                <span id={'hw9-time'}>
                    <strong>{`${stringTime[0]}:${stringTime[1]}:${stringTime[2] < 10 ? '0' + stringTime[2]: stringTime[2]}`}</strong>
                </span>
            </div>
