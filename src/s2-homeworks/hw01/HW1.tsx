...
export const message0: MessageType = {
    id: 0,
    user: {
        avatar: 'https://vraki.net/sites/default/files/mood/b.jpg', // можно менять
...
export const friendMessage0: MessageType = {
    id: 100,
    user: {
        avatar: 'https://abrakadabra.fun/uploads/posts/2022-03/1647302587_3-abrakadabra-fun-p-avatarki-v-maske-6.jpg', // можно менять
